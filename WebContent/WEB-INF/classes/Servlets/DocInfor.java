...
/**
 * Servlet implementation class DocInfor
 */
@WebServlet("/DocInfor")
public class DocInfor extends HttpServlet {//获取常用文档的URL
	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(DocInfor.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			//Domino
			jsonObject=new DominoInform2().getDocment(doctitle, "Doc");
			if(jsonObject !=null)
			{   
