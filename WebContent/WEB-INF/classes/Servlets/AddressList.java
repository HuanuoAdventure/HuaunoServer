 ...
 * 
 * @author duxiaohan
 * TODO 定义客户端获取部门人员列表请求的响应
 */
public class AddressList extends HttpServlet {

	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(AddressList.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			departString=req.getParameter("depart");
			//Mysql
			...
			pStatement.close();*/
			//Domino
			jsonObject=new DominoInform().getInformList(departString, "depart");
			if(jsonObject !=null)
			{
