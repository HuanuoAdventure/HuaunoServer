...
/**
 * Servlet implementation class AnnoList
 * @author 蔡如男
 */
@WebServlet("/AnnoList")
public class AnnoList extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(AnnoList.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			//Domino
			jsonObject=new DominoInform2().getMoreAnnoList(tag);
			if(jsonObject !=null)
			{   
