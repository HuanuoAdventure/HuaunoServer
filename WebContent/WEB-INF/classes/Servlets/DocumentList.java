...
public class DocumentList extends HttpServlet {//点击More获取更多文档
	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(DocumentList.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			//Domino
			jsonObject=new DominoInform2().getDocList(category, "DocumentList");
			if(jsonObject !=null)
			{   
