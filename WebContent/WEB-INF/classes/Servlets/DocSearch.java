...
public class DocSearch extends HttpServlet {//文档搜索功能
	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(DocSearch.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			String str=req.getParameter("docsearch");
			//Domino
			jsonObject=new DominoInform2().getDocList(str, "search");
			if(jsonObject !=null)
			{   
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		pWriter.println("DocumentSearch");
		pWriter.flush();
		pWriter.close();
	}
