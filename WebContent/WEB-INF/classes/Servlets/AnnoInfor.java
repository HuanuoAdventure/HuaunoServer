...
/**
 * Servlet implementation class AnnoInfor
 */
@WebServlet("/AnnoInfor")
public class AnnoInfor extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger=LogManager.getLogger(AnnoInfor.class);//获取logger
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			//Domino
			jsonObject=new DominoInform2().getAnnoInform(Annotitle, "Anno");
			if(jsonObject !=null)
			{   
